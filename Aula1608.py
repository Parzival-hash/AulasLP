...
while Flag:
    ...
    if escolha1== "1":
            escolha2 = input("1-Lista de Produtos\n2-realizar compra\n3-voltar\n")
            
            if escolha2 == "1":
                for x in range(0,len(listaProdutos)):
                    print("Produto:", listaProdutos[x], "\nR$", listaValores[x])
            ...
            if escolha2 == "2":
                ...
                if valorCompraSDesconto >= 3 and valorCompraSDesconto <=4:
                    print("\nValor com %10 desconto:", valorCompraSDesconto*0.1)
                    print("\nValor com %10 desconto:", valorCompraSDesconto - valorCompraSDesconto*0.1)
                
                elif( valorCompraSDesconto >=5):
                    print("\nValor do desconto:", valorCompraSDesconto*0.2)
                    print("\nValor do desconto:", valorCompraSDesconto - valorCompraSDesconto*0.2)
                else:
                    print("Sem Desconto")
                    print("Valor Total:", valorCompraSDesconto)
        

                # valorTotal = maça + banana + pera + uva + morango
